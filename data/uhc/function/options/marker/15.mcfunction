...
scoreboard players set marker uhc.config 15
scoreboard players set marker_compare uhc.config 15
...
title @p actionbar {"text":"Minute Markers every 15 minutes.", "color":"#E25903"}