...
scoreboard players set marker uhc.config 60
scoreboard players set marker_compare uhc.config 60
...
title @p actionbar {"text":"Minute Markers every 60 minutes.", "color":"#E25903"}