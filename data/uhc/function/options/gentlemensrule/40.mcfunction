...
scoreboard players set GRule uhc.config 40
scoreboard players set GRule_compare uhc.config 40
...
title @p actionbar {"text":"Gentleman's Rule for 40 minutes.", "color":"#E25903"}