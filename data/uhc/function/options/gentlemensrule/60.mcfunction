...
scoreboard players set GRule uhc.config 60
scoreboard players set GRule_compare uhc.config 60
...
title @p actionbar {"text":"Gentleman's Rule for 60 minutes.", "color":"#E25903"}