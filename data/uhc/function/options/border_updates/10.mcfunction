...
scoreboard players set border_status uhc.config 10
scoreboard players set border_status_compare uhc.config 10
...
title @p actionbar {"text":"Border status updates every 10 minutes.", "color":"#E25903"}