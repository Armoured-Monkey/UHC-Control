...
scoreboard players set border_status uhc.config 5
scoreboard players set border_status_compare uhc.config 5
...
title @p actionbar {"text":"Border status updates every 5 minutes.", "color":"#E25903"}