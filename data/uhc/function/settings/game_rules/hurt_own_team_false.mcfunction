...
summon text_display 0.5 255.0 -24.0 {text:[{"text":"Hurt Own Team: ","color":"#7f3202","bold":false},{"storage":"uhc_control","interpret":true,"nbt":"friendly_fire","color":"#d9b35c"}],alignment:"center",background:0,transformation:[2,0,0,0,0,2,0,0,0,0,2,0,0,0,0,1],billboard:"fixed",Tags:[uhc.display],UUID:[I;-1703078911,1353270641,-1191100437,1996316231]}
title @p actionbar {"text":"Hurt Own Team: False", "color":"#E25903"}